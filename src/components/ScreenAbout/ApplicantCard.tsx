...
const ApplicantCard = () => {
  ...
  return (
    <div className="bg-white border-black border-[6px] ml-2 w-3/4 h-full rounded-[25px] p-1">
      <VStack className="relative bg-[#de6363] overflow-hidden fix-safari h-full w-full p-3 rounded-[16px]">
        <PokeballFill
          size={560}
          fill="#efb563"
          stroke="#de6363"
          className="absolute top-0 z-[1] left-0 rotate-45 -translate-y-44 -translate-x-44 mt-3"
        />
        <VStack className="w-full h-full z-[2]" align="flex-start" spacing={0}>
          ...
          <HStack className="w-full h-full" align="flex-start" justify="space-between" gap={4}>
            <VStack className="w-3/4">
              ...
              <CardDetail left="graduated" right="May 2024" />
            </VStack>
        ...
        <div className="z-[2] w-full h-full text-[1.8rem] bg-[rgba(255,255,255,0.4)] rounded-[14px] leading-[2.25rem] px-2 py-1.5 text-gray-800">
          <p className="drop-shadow-[1.5px_1px_0.5px_rgba(255,255,255,.8)]">
            ...
            lines.&quot; */}
            &quot;Hi, thank you for visiting my portfolio! Here, you can explore my software
